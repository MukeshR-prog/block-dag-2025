const HowItWorksSection = () => (
  <section
    id="howitworks"
     className="scroll-mt-32 bg-gradient-to-br from-indigo-50 via-white to-indigo-100 pt-28 pb-10 px-2 sm:px-4 md:pt-32 md:pb-18 md:px-16 rounded-2xl shadow-lg mx-auto mt-8 max-w-7xl">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 max-w-6xl mx-auto items-stretch justify-items-center">
      {/* Step 1 */}
      <div className="bg-white/90 p-6 sm:p-8 rounded-xl shadow-lg flex flex-col items-center justify-center text-center h-full w-full mb-4 md:mb-0">
      ...
      {/* Step 4 */}
      <div className="bg-white/90 p-6 sm:p-8 rounded-xl shadow-lg flex flex-col items-center justify-center text-center h-full w-full mb-0">
        <div className="w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-2xl font-bold mb-4">
          4
        </div>
        <h3 className="font-semibold text-xl mb-2 text-indigo-600">
